...
export default function ArmChair() {
  ...
  const { nodes, materials } = useGLTF('https://cdn.jsdelivr.net/gh/Sean-Bradley/React-Three-Fiber-Boilerplate@materialPicker/public/models/armchair-transformed.glb')
...
useGLTF.preload('https://cdn.jsdelivr.net/gh/Sean-Bradley/React-Three-Fiber-Boilerplate@materialPicker/public/models/armchair-transformed.glb')
