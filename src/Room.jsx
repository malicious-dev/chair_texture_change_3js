...
export default function Room() {
  const { nodes, materials } = useGLTF('https://cdn.jsdelivr.net/gh/Sean-Bradley/React-Three-Fiber-Boilerplate@materialPicker/public/models/room-transformed.glb')
...
useGLTF.preload('https://cdn.jsdelivr.net/gh/Sean-Bradley/React-Three-Fiber-Boilerplate@materialPicker/public/models/room-transformed.glb')
